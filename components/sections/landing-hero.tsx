    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                transition={{ duration: 1.2, ease: "easeOut", delay: introPlayed ? 0.1 : 0.3 }}
            >
            ...
            <motion.div
                ...
                transition={{ duration: 0.8, ease: "easeOut", delay: baseDelay > 1 ? 0.2 : 0.1 }}
            >
                {/* Simple PARABOLICA title with accent styles preserved — No staggered animation */}
                <motion.div
                    className="relative inline-block"
                    initial={{ opacity: 0, scale: 0.95 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 0.8, ease: "easeOut", delay: baseDelay > 1 ? baseDelay : 0 }}
                >
                    <h1
                        className="flex justify-center leading-[0.9] tracking-tighter font-black uppercase text-[#fdefef]"
                        style={{
                    ...
                    >
                        P
                        <span style={{ fontStyle: "italic", transform: "skewX(-15deg)", display: "inline-block", letterSpacing: "-0.02em" }}>A</span>
                        R
                        <span style={{ fontStyle: "italic", transform: "skewX(-15deg)", display: "inline-block", letterSpacing: "-0.02em" }}>A</span>
                        BOLI
                        <span style={{ color: "#E84040" }}>C</span>
                        <span style={{ fontStyle: "italic", transform: "skewX(-15deg)", display: "inline-block", letterSpacing: "-0.02em" }}>A</span>
                    </h1>
                </motion.div>
